...
@section('title', 'Automation - Grupo - Ver')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Grupo - Ver</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-3">
            <div class="card card-widget widget-user">
                ...
                <div class="widget-user-image">
                    <img class="img-circle elevation-2" src="{{ env('APP_URL') . '/public/storage/' . $group->image_path }}"
                        alt="User Avatar">
                </div>
                <div class="card-body">
                        ...
                        <div class="col-sm-4">
                            <div class="description-block">
                                <h5 class="description-header">
                                    {{ $group->occuped_seats > 0 ? number_format(100 - (100 / $group->occuped_seats) * 100, 2, ',', '.') : 0 }}
                                </h5>
