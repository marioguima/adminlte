...
@section('title', 'Automation - Painel de Controle')

@section('css')
    <!-- Sparkline -->
    <script src="{{ asset('public/vendor/sparklines/sparkline.js') }}"></script>
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{ asset('public/vendor/jqvmap/jqvmap.min.css') }}">
    <!-- Theme style -->
                    ...
                    <div class="tab-content p-0">
                        ...
                        <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                            ...
                            <canvas id="revenue-chart-canvas" height="300"
                                style="height: 300px; display: block; width: 623px;" width="623"
                    ...
                    <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                            ...
                            <img class="direct-chat-img"
                                src="{{ asset('public/vendor/adminlte/dist/img/user1-128x128.jpg') }}"
                        ...
                        <div class="direct-chat-msg right">
                            ...
                            <!-- /.direct-chat-infos -->
                            <img class="direct-chat-img"
                                src="{{ asset('public/vendor/adminlte/dist/img/user3-128x128.jpg') }}"
                                alt="message user image">
                            <!-- /.direct-chat-img -->
                            <div class="direct-chat-text">
                    ...
                    <div class="direct-chat-contacts">
                        <ul class="contacts-list">
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ asset('public/vendor/adminlte/dist/img/user7-128x128.jpg') }}">
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ asset('public/vendor/adminlte/dist/img/user5-128x128.jpg') }}">
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ asset('public/vendor/adminlte/dist/img/user6-128x128.jpg') }}">
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ asset('public/vendor/adminlte/dist/img/user8-128x128.jpg') }}">
            ...
            <div class="card bg-gradient-primary">
                ...
                <div class="card-body">
                    <div id="world-map"
                        ...
                        <svg width="623" height="250">
                            <g transform="scale(0.42158516020236086) translate(259.37800000000004, 0)">
                                <path
                                ...
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_mi"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_vt"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_me"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ri"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ny"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_pa"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_nj"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_de"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_md"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_va"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_wv"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_oh"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_in"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_il"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ct"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_wi"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_nc"
                                    class="jqvmap-region"></path>
                                <path d="m803.44,248.16c2.67,3.43 3.85,-1.02 0.55,-0.75l-0.29,0.4 -0.25,0.35z"
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_dc"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ma"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_tn"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ar"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_mo"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ga"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_sc"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ky"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_al"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_la"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ms"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ia"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_mn"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ok"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_tx"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_nm"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ks"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ne"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_sd"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_nd"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_wy"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_mt"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_co"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_id"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ut"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_az"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_nv"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_or"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_wa"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#818181" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#f4f3f0" original="#f4f3f0" id="jqvmap1_ca"
                                    class="jqvmap-region"></path>
                            </g>
                        </svg>
            ...
            <div class="card bg-gradient-info">
                ...
                <div class="card-body">
                    ...
                    <canvas class="chart chartjs-render-monitor" id="line-chart"
                        style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 623px;"
                        width="623" height="250"></canvas>
                </div>
                <!-- /.card-body -->
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <div class="col-4 text-center">
                            <div style="display:inline;width:60px;height:60px;"><canvas width="60"
                                    height="60"></canvas><input type="text" class="knob" data-readonly="true" value="20"
                        ...
                        <div class="col-4 text-center">
                            <div style="display:inline;width:60px;height:60px;"><canvas width="60"
                                    height="60"></canvas><input type="text" class="knob" data-readonly="true" value="50"
                                    data-width="60" data-height="60" data-fgcolor="#39CCCC" readonly="readonly"
                                    style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; background: none; font: bold 12px Arial; text-align: center; color: rgb(57, 204, 204); padding: 0px; appearance: none;">
                            </div>
                        ...
                        <div class="col-4 text-center">
                            <div style="display:inline;width:60px;height:60px;"><canvas width="60"
                                    height="60"></canvas><input type="text" class="knob" data-readonly="true" value="30"
                                    data-width="60" data-height="60" data-fgcolor="#39CCCC" readonly="readonly"
                                    style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px; background: none; font: bold 12px Arial; text-align: center; color: rgb(57, 204, 204); padding: 0px; appearance: none;">
                            </div>
                                    ...
                                    <div class="datepicker">
                                        <div class="datepicker-days" style="">
                                            <table class="table table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="picker-switch" data-action="pickerSwitch" colspan="5"
                                                            title="Select Month">September 2020</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="08/30/2020"
                                                            class="day old weekend">30</td>
                                                        <td data-action="selectDay" data-day="08/31/2020" class="day old">31
                                                        </td>
                                                        ...
                                                        <td data-action="selectDay" data-day="09/05/2020"
                                                            class="day weekend">5</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="09/06/2020"
                                                        ...
                                                        <td data-action="selectDay" data-day="09/10/2020" class="day">10
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/11/2020" class="day">11
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/12/2020"
                                                            class="day weekend">12</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="09/13/2020"
                                                            class="day weekend">13</td>
                                                        <td data-action="selectDay" data-day="09/14/2020" class="day">14
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/15/2020" class="day">15
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/16/2020" class="day">16
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/17/2020"
                                                            class="day active today">17</td>
                                                        <td data-action="selectDay" data-day="09/18/2020" class="day">18
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/19/2020"
                                                            class="day weekend">19</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="09/20/2020"
                                                            class="day weekend">20</td>
                                                        <td data-action="selectDay" data-day="09/21/2020" class="day">21
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/22/2020" class="day">22
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/23/2020" class="day">23
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/24/2020" class="day">24
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/25/2020" class="day">25
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/26/2020"
                                                            class="day weekend">26</td>
                                                    </tr>
                                                    <tr>
                                                        <td data-action="selectDay" data-day="09/27/2020"
                                                            class="day weekend">27</td>
                                                        <td data-action="selectDay" data-day="09/28/2020" class="day">28
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/29/2020" class="day">29
                                                        </td>
                                                        <td data-action="selectDay" data-day="09/30/2020" class="day">30
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/01/2020" class="day new">1
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/02/2020" class="day new">2
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-action="selectDay" data-day="10/05/2020" class="day new">5
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/06/2020" class="day new">6
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/07/2020" class="day new">7
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/08/2020" class="day new">8
                                                        </td>
                                                        <td data-action="selectDay" data-day="10/09/2020" class="day new">9
                                                        </td>
...
@section('js')
    ...
    <!-- JQVMap -->
    <script src="{{ asset('public/vendor/jqvmap/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('public/vendor/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
    <!-- jQuery Knob Chart -->
    <script src="{{ asset('public/vendor/jquery-knob/jquery.knob.min.js') }}"></script>
    <!-- daterangepicker -->
