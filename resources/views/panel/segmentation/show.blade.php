...
@section('title', 'Automation - Segmentação - Ver')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Segmentação - Ver</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ $segmentation->name }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4>Grupos - {{ $segmentation->groups->count() }}</h4>
                                    {{-- <div class="post">
                        ...
                        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                            ...
                            <textarea class="text-muted" style="width:100%;" rows="5" readonly>{{ $segmentation->description }}</textarea>
                            <br>
                            <div class="text-muted">
                                <p class="text-sm">Data da Criação
                                    <b class="d-block">{{ date('d-m-Y H:i:s', strtotime($segmentation->created_at)) }}</b>
                                </p>
                                <p class="text-sm">Última Atualização
                                    <b class="d-block">{{ date('d-m-Y H:i:s', strtotime($segmentation->updated_at)) }}</b>
                                </p>
                            </div>
